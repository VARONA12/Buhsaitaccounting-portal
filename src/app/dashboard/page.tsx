    ...
    <DashboardShell>
      ...
      <div className="flex flex-col xl:flex-row gap-8 mb-12 relative z-10">
        <motion.div 
          ...
          className="flex-1"
        >
          <h1 className="text-5xl font-extrabold tracking-tight mb-4 leading-tight text-text">
            С возвращением,<br />
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-text-muted text-xl font-light">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12 pb-12 relative z-10">
        <motion.div 
          whileHover={{ y: -5 }}
          className="lg:col-span-2 glass rounded-3xl border border-border p-8 shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="space-y-8">
            {[
              ...
              >
                <div className="w-28 h-20 rounded-2xl bg-surface border border-border shrink-0 overflow-hidden flex items-center justify-center">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[10px] text-text-muted font-mono italic">{news.date}</span>
                  </div>
                  <h4 className="text-lg font-semibold text-text leading-tight group-hover:text-primary transition-colors duration-300">{news.title}</h4>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <motion.div 
          ...
          className="glass rounded-3xl border border-border p-8 flex flex-col items-center text-center justify-center shadow-2xl"
        >
          ...
          <h3 className="text-xl font-bold text-text mb-3 text-glow">Синхронизация с 1С</h3>
          <p className="text-sm text-text-muted mb-8 px-4 font-light leading-relaxed">Ваши данные обновляются в реальном времени.</p>
          <div className="flex items-center gap-3 text-primary font-mono text-[10px] mb-8 bg-surface border border-primary/20 px-4 py-2 rounded-full">
