...
export default async function NewsPage() {
  ...
  const stripEmoji = (s: string) => s.replace(/[\u{1F600}-\u{1F64F}\u{1F300}-\u{1F5FF}\u{1F680}-\u{1F6FF}\u{1F1E0}-\u{1F1FF}\u{2702}-\u{27B0}\u{24C2}-\u{1F251}\u{1F900}-\u{1F9FF}\u{2600}-\u{26FF}\u{FE00}-\u{FE0F}\u{200D}\u{2B50}-\u{2B55}\u{203C}-\u{3299}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}]/gu, '').trim();
