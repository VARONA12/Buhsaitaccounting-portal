...
const servicesData = [
  {
    ...
    title: "ООО (НДС)",
    price: "от 20 000 ₽",
    desc: "Полное бухгалтерское сопровождение и сдача отчетности для организаций на общей системе с НДС.",
    details: [
      "Полный учёт НДС: защита по 115-ФЗ и банковский комплаенс",
      "НДС: формирование книг, налоговое планирование и законная оптимизация",
    ],
    features: ["Для ООО", "НДС", "Защита 115-ФЗ"],
  ...
  },
  {
    ...
    title: "ООО (УСН)",
    price: "от 10 000 ₽",
    desc: "Полное бухгалтерское сопровождение и сдача отчетности для организаций на УСН.",
    details: [
      "УСН: ведение выписок, КУДиР, начисление зарплаты",
    ],
    features: ["Для ООО", "УСН", "Безопасность"],
