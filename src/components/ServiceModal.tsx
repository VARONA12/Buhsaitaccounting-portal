        ...
        <>
          ...
          <div className="fixed inset-0 z-[201] flex items-end sm:items-center justify-center p-0 sm:p-6 overflow-hidden">
            <motion.div
              ...
              className="w-full h-[100dvh] sm:h-auto sm:max-w-2xl bg-[#0B0B0B] border-t sm:border border-white/10 sm:rounded-[40px] shadow-2xl pointer-events-auto flex flex-col relative sm:max-h-[90vh] rounded-t-[32px] sm:rounded-b-[40px] z-[210]"
            >
              ...
              <div className="relative flex items-center justify-between p-6 sm:p-0 sm:absolute sm:top-8 sm:right-8 z-30 shrink-0">
                ...
                <button 
                  onClick={onClose}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-white/10 flex items-center justify-center text-neutral-400 hover:bg-white hover:text-black transition-all bg-neutral-900/50 backdrop-blur-md"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="p-6 sm:p-8 bg-[#0B0B0B] border-t border-white/5 shrink-0 safe-bottom">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
                   ...
                   <button 
                     onClick={onClose}
                     className="w-full sm:w-auto px-10 py-5 bg-primary text-black rounded-xl sm:rounded-2xl font-bold uppercase tracking-widest hover:bg-white transition-all text-[11px] shadow-xl active:scale-95"
                   >
                     Понятно, спасибо
                   </button>
                </div>
